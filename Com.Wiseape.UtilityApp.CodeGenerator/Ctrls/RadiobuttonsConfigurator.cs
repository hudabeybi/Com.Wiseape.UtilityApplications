...
{
    public partial class RadiobuttonsConfigurator : UserControl, IConfigContent
    {
        public RadiobuttonsConfigurator()
        {
            InitializeComponent();
        }
        ...
        {
            return ControlType.Radiobuttons.ToString();
        }
        ...
        private void RadiobuttonsConfigurator_Load(object sender, EventArgs e)
        {
